...
5. Last, but certainly not least, of my favorite framework(s) is the family of frameworks based on [MDX](https://mdxjs.com/). Before that, let's understand what is MDX and how does it vary from MD. Quoting from [MDXJS](https://mdxjs.com/):
